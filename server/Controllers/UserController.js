...
exports.signUp = async (req, res) => {
    ...
    const { pseudo, email, emailConfirm, password, passwordConfirm, lastname, firstname } = req.body;

    const fisrtnameVerify = isEmpty(fisrtname, 'Vous devez indiquer un pseudo');
    const lastnameVerify = isEmpty(lastname, 'Vous devez indiquer un pseudo');
    ...
    if (
        fisrtnameVerify.error === true ||
        lastnameVerify.error === true ||
        ...
        dataMessage.push(
            { message: fisrtnameVerify.message },
            { message: lastnameVerify.message },
